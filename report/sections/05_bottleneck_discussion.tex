...
were responsible the largest portion of program time. Below is the configuration for the model and training set size used in the profiling.
...
\hline
linear\_kernel\_untiled & 80.86\% & 70.3209 s & 490000 & 143.51 $\mu$s & 464.80 $\mu$s \\
...
\hline
\end{tabular}
\caption{CUDA Kernel Profiling Results for Parallel Implementation with Tiling}
\end{table}